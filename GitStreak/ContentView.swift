                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Group {
                        Text("1. Acceptance of Terms")
                            .font(.headline)
                        Text("By using GitStreak, you agree to be bound by these Terms.")
                            .font(.body)
                        
                        Text("2. Description of Service")
                            .font(.headline)
                        Text("GitStreak is a personal productivity tool that tracks your GitHub contribution activity and displays commit streaks and statistics.")
                            .font(.body)
                        
                        Text("3. User Requirements")
                            .font(.headline)
                        Text("You must be at least 13 years of age, have a valid GitHub account, and comply with GitHub's Terms of Service.")
                            .font(.body)
                        
                        Text("4. Disclaimer")
                            .font(.headline)
                        Text("THE APP IS PROVIDED \"AS IS\" WITHOUT WARRANTIES OF ANY KIND. Use at your own risk.")
                            .font(.body)
                        
                        Text("5. Contact")
                            .font(.headline)
                        Text("For questions about these Terms, please contact us through the Help & Support section.")
                            .font(.body)
                    }
                }
                .padding(24)
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    Group {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            HelpItem(
                                ...
                                description: "Tap the gear icon and enter your Personal Access Token."
                            )
                            
                            HelpItem(
                                icon: "2.circle.fill", 
                                title: "Generate a Token",
                                description: "Visit GitHub Settings → Personal access tokens with 'repo' and 'user' scopes."
                            )
                            
                            HelpItem(
                                icon: "3.circle.fill",
                                title: "View Your Stats", 
                                description: "Your commit streaks and activity will automatically sync."
                            )
                        }
                    }
                    ...
                    Group {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            Text("Q: Why isn't my data updating?")
                                .font(.headline)
                            Text("A: Pull down to refresh on any screen to sync with GitHub.")
                                .font(.body)
                                .foregroundColor(.secondary)
                            
                            Text("Q: How are streaks calculated?")
                                .font(.headline)
                            Text("A: Streaks count consecutive days with at least one commit.")
                                .font(.body)
                                .foregroundColor(.secondary)
                            
                            Text("Q: Is my GitHub token secure?")
                                .font(.headline)
                            Text("A: Yes! Your token is stored securely in the iOS Keychain.")
                                .font(.body)
                                .foregroundColor(.secondary)
                        }
                    }
