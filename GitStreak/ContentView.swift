...
// MARK: - AppConstants (Temporary for build)
struct AppConstants {
...
// MARK: - Legal Views (Temporary stubs for build)
        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Text("GitStreak is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our iOS application.")
                        .font(.body)
                    ...
                    Text("• GitHub Personal Access Token (stored securely in iOS Keychain)\n• GitHub activity data (processed locally on device)\n• No data is sent to external servers")
                        .font(.body)
                    ...
                    Text("All sensitive data is stored in the iOS Keychain with encryption. GitHub activity data is cached locally on your device.")
                        .font(.body)
                }
                .padding(24)
            }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text("1. Connect your GitHub account with a Personal Access Token")
                            .font(.body)
                        
                        Text("2. Generate a token with 'repo' and 'user' scopes")
                            .font(.body)
                        
                        Text("3. View your commit streaks and activity")
                            .font(.body)
                    }
